...
<https://github.ubc.ca/MDS-2020-21/DSCI_522_individual_assignment_2_dengjr.git>
...
The R programming language(R Core Team 2020)and the following R packages
were used to perform the analysis: knitr (Xie 2020) and tidyverse
(Wickham et al. 2019). The code used to perform the analysis and create
